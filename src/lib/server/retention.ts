 ...
 * output for 30 days, conversations read from computers for a week. Deleted
 * as the server goes about its work (the team page loading, computers checking
 * in), at most every ten minutes per server instance.
 */
